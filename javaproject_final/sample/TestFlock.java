...
import sample.*;
import flockbase.Bird2017019;
import flockbase.Flock2017019;
...
public class TestFlock {
	public static void main(String[] args) {
		Flock f = new Flock2017019(); // where FlockX is a concrete derived class of Flock

		// add a bunch of birds

		// repeat the above for the different derived classes of bird
		Bird b1 = new Bird2017019(); // where BirdX is a derived concrete class of Bird
		b1.setPos(10,10);
		f.addBird(b1);

		for(int i=0;i<5;i++){

			Bird b = new Bird2017019();
			b.setPos(i*100,  10);
			f.addBird(b);
